...
- [ ] Batch 27: Build a `$27` Writing Desk Story Prompt Strip Pack with adult-led printable prompt strips, no account/review/public-posting flow, static product page, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] $27 writing desk story prompt strip pack with adult-led printable prompt strips and no public reviews, accounts, or real-child data.
