...
- [ ] Batch 25: Build the `$29` Kitchen Table Story Recipe Card Deck with adult-led paper recipe-card writing prompts, no food prep/tasting/allergy advice, static product page, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] $29 kitchen table story recipe card deck with adult-led paper recipe-card writing prompts and no food prep, tasting, or allergy advice.
