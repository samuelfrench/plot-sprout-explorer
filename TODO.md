...
- [ ] Batch 24: Build the `$35` Backyard Story Seed Packet Kit with adult-led printable seed-packet story prompts, observation-safe garden/yardside writing cards, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] Batch 24: Build the `$35` Backyard Story Seed Packet Kit with adult-led seed-packet story prompts, safe observation language, static product page, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] $35 backyard story seed packet kit with adult-led safe-observation story cards and take-home seed-packet prompts.
