...
- [ ] Batch 28: Build a `$29` Window Seat Story Scene Card Pack with adult-led printable scene cards, no account/review/public-posting flow, static product page, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] $29 window seat story scene card pack with adult-led printable scene cards and no public reviews, accounts, or real-child data.
