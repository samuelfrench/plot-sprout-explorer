...
- [ ] Batch 26: Build a `$25` Bookshop Story Bookmark Pack with adult-led printable bookmark writing prompts, no account/review/public-posting flow, static product page, local product image, PDF/source/ZIP artifact, and validation that checkout stays pending.
...
- [ ] $25 bookshop story bookmark pack with adult-led printable bookmark prompts and no public reviews, accounts, or real-child data.
